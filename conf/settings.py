...
UPDATE_FILE_PATH = DATA_FOLDER_PATH + '/update_info.txt'
...
DELPOY_PLATFORM = "GITHUB_ACTION" #"VPS"
...
if MAIL['email'] == None or MAIL['password'] == None or MAIL['receivers'] == None:
    MAIL['email'] = os.environ.get('MAILUSERNAME')
    MAIL['password'] = os.environ.get('MAILPASSWORD'),
